...
from PandaXMusic.misc import _boot_
from PandaXMusic.plugins.sudo.sudoers import sudoers_list
...
from PandaXMusic.utils.decorators.language import LanguageStart
from PandaXMusic.utils.formatters import get_readable_time
from PandaXMusic.utils.inline import help_pannel, private_panel, start_panel
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        try:
            ...
            await lols.edit_text("**⚡ѕтαятιиg.**")
            await lols.edit_text("**⚡ѕтαятιиg....🤪**")
            m = await message.reply_sticker("CAACAgUAAxkBAAIe8mmqfnD0jSxHb4kreFzJvcfPFKKbAAIZGwAC1TmgVSBQbkNGcGBSHgQ")
