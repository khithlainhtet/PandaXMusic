...
from PandaXMusic.utils.database import add_sudo, remove_sudo
from PandaXMusic.utils.decorators.language import language
from PandaXMusic.utils.extraction import extract_user
from PandaXMusic.utils.filters_func import DevID
from PandaXMusic.utils.inline import close_markup
...
async def sudoers_list(client, message: Message, _):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("💔 <b>ᴏᴡɴᴇʀs:</b>\n1➤ <a href='https://t.me/HANTHAR999'>⛦°𝐏𝐀𝐍𝐃𝐀 𓆩🇽𓆪 𝗞𝗜𝗡𝗚🇳</a>",
